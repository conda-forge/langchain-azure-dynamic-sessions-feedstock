About langchain-azure-dynamic-sessions-feedstock
================================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/langchain-azure-dynamic-sessions-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/langchain-azure-dynamic-sessions-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add langchain-azure-dynamic-sessions
# for installing globally
pixi global install langchain-azure-dynamic-sessions
```
...
It is possible to list all of the versions of `langchain-azure-dynamic-sessions` available on your platform:
...
```
pixi search langchain-azure-dynamic-sessions --channel conda-forge
```
